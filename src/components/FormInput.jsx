...
const FormInput = ({info}) => {
    ...
    <TextField type="number" placeholder="DD" color="secondary" {...register("day",{
    ...
    <Box width="100%" border="0.5px solid hsl(0, 15.60%, 66.10%)" sx = {{opacity:"50%"}}/>
    <Fab type="submit" size="large" className="sumbit-btn">  {/* sx =  {{position: "relative", left: {lg:"50px", md:"30px",sm:"-30px",xs:"-150px"},}} */}
